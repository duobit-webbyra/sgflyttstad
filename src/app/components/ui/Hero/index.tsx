    ...
    <div className="relative">
      ...
      <Container className="relative flex gap-16 pb-44 pt-32">
        <div className="flex flex-col justify-center gap-6">
          <h1 className="text-[3rem] font-bold leading-snug tracking-tight">{title}</h1>
        ...
        <div className="flex flex-col gap-12 py-16 md:py-24 xl:flex-row">
          <div className="flex flex-col justify-center gap-6">
            ...
            <p className="text-xl md:w-2/3">
              Vi hjälper dig med hela flytten, från transport till städning, så att du kan slappna
              av och fokusera på ditt nya hem.
            </p>
